...
const THEMES = [
  ...
  { id: 'midnight',    name: '賽博紫', en: 'Cyber',     bg: '#0e0040', card: '#1a0066', p: '#b060ff', s: '#ff55bb' },
  { id: 'ocean',       name: '深海藍', en: 'Ocean',     bg: '#001840', card: '#002860', p: '#00aaff', s: '#5566ff' },
  { id: 'aurora',      name: '極光綠', en: 'Aurora',    bg: '#003320', card: '#005030', p: '#2dffa5', s: '#00ccee' },
  { id: 'sunset',      name: '焰橙',   en: 'Flame',     bg: '#2e0a00', card: '#481400', p: '#ff6600', s: '#ffaa00' },
  { id: 'forest',      name: '抹茶',   en: 'Matcha',    bg: '#182400', card: '#263800', p: '#7ec84a', s: '#a8d870' },
